...
public class YQLBaseClientThread extends AsyncTask<String, Void, Void> {
	...
	public void getWeather(String woeid) {
		...
		String yql = "select * from weather.forecast where u=\"c\" and woeid="
				+ woeid;
		yql = encodeUrl(yql);
	...
	public void getGoogleNews() {

		// https://tw.news.yahoo.com/_remote/?m_id=MediaRemoteInstance&m_mode=fragment&instance_id=ee9cbef3-8a4c-375c-8d33-51811fec3d98&site=news&content_id=f731ab52-98c6-3225-a400-9a9f56513abc&mod_id=mediatabs_nmid_2&mod_units=16&nolz=1
		String yql = "select * from json where url=\"https://ajax.googleapis.com/ajax/services/search/news?v=1.0&q=台灣\"";
		this.getYQL(yql);

	}

	public void getGoogleNewsContent(String contentUrl) {
		// https://tw.news.yahoo.com/_remote/?m_id=MediaRemoteInstance&m_mode=fragment&instance_id=ee9cbef3-8a4c-375c-8d33-51811fec3d98&site=news&content_id=f731ab52-98c6-3225-a400-9a9f56513abc&mod_id=mediatabs_nmid_2&mod_units=16&nolz=1
		String url = "https://ajax.googleapis.com/ajax/services/search/news?v=1.0&q=台灣";
		this.execute(url);
	}

	public void getNewContentUrl(String newsUrl) {
		String xpath = " and xpath='//div[@id=\"mediaarticlebody\"]/*/p'";
		String yql = "select * from html where url=\"" + newsUrl + "\"" + xpath;
		this.getYQL(yql);
	}
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			Log.e("start::::", String.valueOf(count));
			for (int i = 0; i < count; i++) {
				Log.e("Loop start::::", String.valueOf(i));

				url = params[i];
				Log.e("Loop start::::", url);
